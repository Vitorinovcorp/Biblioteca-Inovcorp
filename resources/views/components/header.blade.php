    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4">
            <div class="flex flex-col space-y-2">
                <a href="/livros"
                    class="{{ request()->is('livros') ? 'bg-blue-700' : 'hover:bg-blue-700' }} px-3 py-2 rounded transition block">
                    Livros
                </a>
                <a href="/editoras"
                    class="{{ request()->is('editoras') ? 'bg-blue-700' : 'hover:bg-blue-700' }} px-3 py-2 rounded transition block">
                    Editoras
                </a>
                <a href="/autores"
                    class="{{ request()->is('autores') ? 'bg-blue-700' : 'hover:bg-blue-700' }} px-3 py-2 rounded transition block">
                    Autores
                </a>
                <a href="{{ route('requisicoes.index') }}"
