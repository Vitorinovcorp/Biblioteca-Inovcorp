    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="book-info">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php endif; ?><?php if($requisicao->livro->capa): ?>
                ...
                <p><strong>Título:</strong> <?php echo e($requisicao->livro->nome); ?></p>
                <p><strong>ISBN:</strong> <?php echo e($requisicao->livro->isbn); ?></p>
                <p><strong>Autores:</strong> 
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $requisicao->livro->autores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <p><strong>Nome:</strong> <?php echo e($requisicao->user->name); ?></p>
                <p><strong>Email:</strong> <?php echo e($requisicao->user->email); ?></p>
                <p><strong>Telefone:</strong> <?php echo e($requisicao->user->telefone ?? 'Não informado'); ?></p>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php endif; ?><?php if($requisicao->user->foto): ?>
                    <p><strong>Foto do Cidadão:</strong></p>
                    <img src="<?php echo e(asset('storage/' . $requisicao->user->foto)); ?>" 
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php endif; ?><?php if($requisicao->observacoes): ?>
