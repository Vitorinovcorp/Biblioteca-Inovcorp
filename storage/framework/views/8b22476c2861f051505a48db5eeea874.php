...
<div class="container mx-auto px-4 py-8">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!isset($encomenda) || !$encomenda): ?>
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
            <p>Encomenda não encontrada. <a href="<?php echo e(route('carrinho.index')); ?>" class="underline">Voltar ao carrinho</a></p>
        </div>
    <?php else: ?>
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4 max-h-96 overflow-y-auto mb-4">
                ...
                <div class="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                    <div class="w-16 h-20 bg-gray-200 rounded overflow-hidden flex-shrink-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->livro && $item->livro->imagem_capa): ?>
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-800"><?php echo e($item->livro->nome ?? 'Livro não disponível'); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($item->livro->autores->pluck('nome')->implode(', ') ?? 'Autor não informado'); ?></p>
                        <div class="flex justify-between items-center mt-2">
                            <span class="text-sm"><?php echo e($item->quantidade); ?>x € <?php echo e(number_format($item->preco_unitario, 2, ',', '.')); ?></span>
                            <span class="font-bold text-purple-600">€ <?php echo e(number_format($item->subtotal, 2, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-t pt-4 space-y-2">
                <div class="flex justify-between text-gray-600">
                    <span>Subtotal:</span>
                    <span>€ <?php echo e(number_format($encomenda->total, 2, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between text-gray-600">
                    <span>Envio:</span>
                ...
                <div class="flex justify-between text-xl font-bold text-gray-800 pt-2 border-t">
                    <span>Total:</span>
                    <span class="text-purple-600">€ <?php echo e(number_format($encomenda->total, 2, ',', '.')); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form id="payment-form">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="encomenda_id" value="<?php echo e($encomenda->id); ?>">
                ...
                <button type="submit" id="submit-button" class="w-full bg-purple-600 text-white font-bold py-3 rounded-lg hover:bg-purple-700 transition">
                    ...
                    Pagar € <?php echo e(number_format($encomenda->total, 2, ',', '.')); ?>
...
<script>
    ...
    form.addEventListener('submit', async function(event) {
        ...
        if (!cardholderName) {
            ...
            submitButton.innerHTML = '<i class="fab fa-stripe mr-2"></i> Pagar € <?php echo e(number_format($encomenda->total, 2, ',', '.')); ?>';
            return;
        }
        ...
        if (error) {
            ...
            const response = await fetch('<?php echo e(route("carrinho.processar-pagamento")); ?>', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                window.location.href = '<?php echo e(route("carrinho.sucesso", ["encomenda" => $encomenda->id])); ?>';
            } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Vitor Ferreira\Herd\biblioteca-inovcorp\resources\views/carrinho/pagamento.blade.php ENDPATH**/ ?>