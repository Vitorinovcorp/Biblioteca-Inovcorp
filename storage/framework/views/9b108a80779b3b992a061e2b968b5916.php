    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('google-books.do-search')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> text-gray-700" 
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="invalid-feedback d-block text-center text-gray-700"><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
