    ...
    <div class="max-w-7xl mx-auto">
        <div id="livros-container" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($results) && isset($results['items']) && count($results['items']) > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $results['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <?php elseif(isset($results) && isset($results['items']) && count($results['items']) === 0): ?>
                <div class="col-span-3 text-center py-10 text-gray-500">
                    ...
                    <p>Nenhum livro encontrado para "<?php echo e($query ?? ''); ?>"</p>
                </div>
            <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (searchForm) {
        searchForm.addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("google-books.do-search")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
